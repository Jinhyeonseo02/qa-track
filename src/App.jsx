...
const QA_COURSES = [
  ...
  { name: "게임 빌딩 스토리텔링 (Game building Storytelling)", why: "디지털콘텐츠학부 과목. 게임 구조·시나리오를 이해해 QA 시나리오 설계.", tag: "심화" },
